            ...
            <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6">
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400" title="Decrease goal: Nhập Start > Target. Increase goal: Nhập Start < Target">
                            ...
                            <label class="flex items-start gap-3 cursor-pointer" :class="{ 'opacity-50': !canSetCoreGoal && !form.is_core_goal }">
                                ...
                                <div>
                                    ...
                                    <p v-if="!canSetCoreGoal" class="text-sm text-amber-600 dark:text-amber-400 mt-1">
                                        ⚠️ You already have {{ coreGoalsCount }}/3 Core Goals. Uncheck another goal to add a new one.
                                    </p>
                                </div>
                            </label>
